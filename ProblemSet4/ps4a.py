...
WORDLIST_FILENAME = "C:/Users/mbaron/Desktop/GitHub/Side Projects/ProblemSet4/words.txt"
...
def getWordScore(word, n):
    ...
    if len(word) == n: return 50+(score*len(word))
...
def isValidWord(word, hand, wordList):
    ...
    for i in wordDict:
        if newHand.get(i, -1) <= 0:
            return False
        if (newHand.get(i) - wordDict.get(i)) < 0:
            return False
    return True
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                totalScore += points
                print '"%s" earned %s points. Total: %s points' %(userInput, points, totalScore)
                print
                # Update the hand
